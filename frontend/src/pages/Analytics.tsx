...
> = {
  ...
  es: {
    title: 'Analitica',
    subtitle: 'Metricas de rendimiento y comportamiento de pagos',
    conversion: 'Conversion',
    avgTicket: 'Ticket promedio',
    activeLinks: 'Links activos',
    settledLinks: 'Links liquidados',
    settleSpeed: 'Liquidacion prom.',
    statusMixTitle: 'Distribucion de estados',
    statusMixSubtitle: 'Mix actual de etapas del ciclo de pago',
    assetMixTitle: 'Volumen pagado por activo',
    assetMixSubtitle: 'Distribucion de montos confirmados',
    trendTitle: 'Tendencia de actividad',
    trendSubtitle: 'Tendencia de links creados en el periodo seleccionado',
    topClientsTitle: 'Top clientes',
    topClientsSubtitle: 'Clientes mas activos por volumen pagado',
    noData: 'Aun no hay suficientes datos',
    paid: 'Pagado',
  ...
  pt: {
    title: 'Analitica',
    subtitle: 'Metricas de performance e comportamento de pagamentos',
    conversion: 'Conversao',
    avgTicket: 'Ticket medio',
    activeLinks: 'Links ativos',
    settledLinks: 'Links liquidados',
    settleSpeed: 'Liquidacao med.',
    statusMixTitle: 'Distribuicao de status',
    statusMixSubtitle: 'Mix atual das etapas do ciclo de pagamento',
    assetMixTitle: 'Volume pago por ativo',
    assetMixSubtitle: 'Distribuicao de valores confirmados',
    trendTitle: 'Tendencia de atividade',
    trendSubtitle: 'Tendencia de links criados no periodo selecionado',
    topClientsTitle: 'Top clientes',
