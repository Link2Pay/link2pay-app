...
const COPY: Record<Language, {
  ...
  en: {
    ...
    noClientsEmpty: 'No clients yet. Add one now or save clients while creating payment links.',
    removeFavorite: 'Remove favorite',
    markFavorite: 'Mark as favorite',
    useInInvoice: 'Use in Link',
  ...
  es: {
    ...
    noClientsEmpty: 'Aun no hay clientes. Agrega uno o guardalos al crear links de pago.',
    removeFavorite: 'Quitar favorito',
    markFavorite: 'Marcar favorito',
    useInInvoice: 'Usar en link',
  ...
  pt: {
    ...
    noClientsEmpty: 'Ainda nao ha clientes. Adicione agora ou salve ao criar links de pagamento.',
    removeFavorite: 'Remover favorito',
    markFavorite: 'Marcar favorito',
    useInInvoice: 'Usar no link',
