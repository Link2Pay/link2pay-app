/**
 * Índice SOLO PARA DESARROLLO: lista los escenarios de preview del checkout.
 * Montado únicamente tras `import.meta.env.DEV` en App.tsx, por lo que no se
 * registra ni se empaqueta en producción. Punto de entrada para QA visual.
 */
    ...
    <div className="min-h-screen bg-background p-4 sm:p-6">
      <div className="mx-auto w-full max-w-lg">
        <div className="mb-6 flex items-center gap-3">
          ...
          <div>
            <h1 className="font-display text-xl font-extrabold text-ink-0">Checkout preview</h1>
            <p className="text-xs text-ink-3">Solo desarrollo · escenarios mock del checkout público</p>
          </div>
        </div>
          ...
          {MOCK_SCENARIOS.map((s) => (
            ...
            >
              <div className="min-w-0">
                ...
                <p className="truncate font-mono text-2xs text-ink-3">/pay/{s.id}</p>
              </div>
